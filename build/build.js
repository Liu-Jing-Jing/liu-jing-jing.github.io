...
/***/ function(module, exports, require) {
	...
	var nowDate = Moment('2050-2-16', 'YYYY-MM-DD');

	alert(os().isFireFox ? '火狐浏览器 = ': '非火狐浏览器 = ' + nowDate.diff(birthDay, 'years') + '岁')
	var initTodos = [
	...
	function generateDateArray(startDate, endDate, duration, getTitle, remarkList) {
	  var dates = [];
	  var currentData = startDate
	  while (currentData.valueOf() <= endDate.valueOf()) {
	    var remark = remarkList[dates.length] || ''
	    dates.push({
...
/***/ function(module, exports, require) {
	...
	var Eventor=require(4),F_tap=require(5),PickerDialog=function(t){if(this.params={},"[object Object]"===Object.prototype.toString.call(t)&&(this.params={input:t.input||"",container:document.querySelector(t.input)||"",innerHTML:t.innerHTML||"",onOpen:t.onOpen||function(){},onClose:t.onClose||function(){},_open:t._open||function(){},_close:t._close||function(){}},this.input=document.querySelector(t.input)),!!document.querySelectorAll(".picker-mask").length<=0){var e=document.createElement("a");e.className="picker-mask",e.href="javascript:void(0);",document.body.appendChild(e)}var n;return n=t.container?t.container:document.createElement("div"),n.className="picker-dialog",t.container||document.body.appendChild(n),this.mask=document.querySelector(".picker-mask"),this.container=document.querySelectorAll(".picker-dialog"),this.container=this.container[this.container.length-1],this._bindEvents(),t=null,this};Eventor.mixTo(PickerDialog),PickerDialog.prototype.updateInputPosition=function(){this._hackInputFocus()},PickerDialog.prototype._bindEventInput=function(){var t=this;F_tap.untap(this.input);var e=function(){var e,n,o,i,r;t.show(),e=document.documentElement.clientHeight,n=document.body.scrollTop,o=t.container.offsetHeight,i=t.input.getBoundingClientRect().top+n,r=t.input.offsetHeight,(i-n+r>e-o||i-n+r<r)&&t.scrollAnimate(i-(e-o)/2,400)};return F_tap.tap(this.input,e),F_tap.tap(this.params.container,e),this},PickerDialog.prototype.scrollAnimate=function(t,e){var n=this,o=(document.body.scrollTop-t)/e*25,i=-1;return n.interval=setInterval(function(){Math.abs(document.body.scrollTop-t)<Math.abs(o)&&clearInterval(n.interval),i=document.body.scrollTop,document.body.scrollTop=i-o,i==document.body.scrollTop&&clearInterval(n.interval)},8),this},PickerDialog.prototype._bindEvents=function(){function t(t){e.hide(),e.emit("close")}var e=this;return F_tap.tap(this.mask,t),this.container.addEventListener("touchmove",function(t){return t.stopPropagation(),t.preventDefault(),!1},!1),this},PickerDialog.prototype.show=function(){var t=this;return t.mask.classList.add("show"),t.params._open&&t.params._open(this),t.params.onOpen&&t.params.onOpen(this),this},PickerDialog.prototype.hide=function(){var t=this;return t.mask.classList.remove("show"),t.params._close&&t.params._close(this),t.params.onClose&&t.params.onClose(this),this},PickerDialog.prototype.html=function(t){return this.container.innerHTML=t,this},module.exports=PickerDialog;
...
/***/ function(module, exports, require) {
	...
	var Event={tap:function(t,e){return t?(t.__tap={},t.__tap.event={start:function(e){e.stopPropagation(),t.__tap.clickabled=!0,t.__tap.starttime=e.timeStamp,t.__tap.startPageX=e.changedTouches[0].pageX,t.__tap.startPageY=e.changedTouches[0].pageY},move:function(e){(Math.abs(e.changedTouches[0].pageX-t.__tap.startPageX)>=5||Math.abs(e.changedTouches[0].pageY-t.__tap.startPageY)>=5)&&(t.__tap.clickabled=!1)},end:function(a){a.stopPropagation(),a.preventDefault(),a.timeStamp-t.__tap.starttime>30&&a.timeStamp-t.__tap.starttime<300&&t.__tap.clickabled&&e&&e(a)},click:function(t){t.stopPropagation(),e&&e(t)}},navigator.userAgent.match(/AppleWebKit.*Mobile.*/)?(t.addEventListener("touchstart",t.__tap.event.start,!1),t.addEventListener("touchmove",t.__tap.event.move,!1),t.addEventListener("touchend",t.__tap.event.end,!1)):t.addEventListener("click",t.__tap.event.click,!1),t):console.error("tap对象不能为空")},untap:function(t){return t?(t.__tap=t.__tap||{},navigator.userAgent.match(/AppleWebKit.*Mobile.*/)&&t.__tap.event?(t.__tap.event.start&&t.removeEventListener("touchstart",t.__tap.event.start,!1),t.__tap.event.move&&t.removeEventListener("touchmove",t.__tap.event.move,!1),t.__tap.event.end&&t.removeEventListener("touchend",t.__tap.event.end,!1)):t.__tap.event&&t.__tap.event.click&&t.removeEventListener("click",t.__tap.event.click,!1),t):console.error("untap对象不能为空")}};window.__tap__=Event.tap,window.__untap__=Event.untap,module.exports=Event;
	...
	module.exports = {
	  ...
	  ready: function() {
	    ...
	    return setTimeout(function() {
	      ...
	      return ck = new window.timer('2025-12-31').on('tick', (function(_this) {
	  ...
	  methods: {
	    getUUID: function(index) {
	      return 'checkbox_' + Math.random().toString(36).substring(3, 8) + index;
	    },
	    setNotification: function() {
	      console.log(this.vm);
	      this.vm.$root.showPopup = true;
	      return window.popupInst.show();
	    },
	    ...
	    expectHCG: function(index) {
	      ...
	      if (index > 0) {
	        ...
	        expectValue = Number(this.$root.hcgList[index - 1].HCG * 4).toFixed(2);
	        return expectValue;
	      } else {
	        return null;
	      }
	    ...
	    editCellValue: function(value, typename) {
	      ...
	      inputValue && (function() {
	        switch (this.vm.$root.tabSelect) {
	          case 1:
	            return this.vm.HCG = inputValue;
	          case 2:
	            return this.vm.E2 = inputValue;
	          case 3:
	            return this.vm.Prog = inputValue;
	        }
	      }).call(this);
	      return this.vm.isEdit = true;
	    },
	    ...
	    initLocalData: function() {
	      var b, div, endDate, g, hcgDate, hcgEndDate, newData, otherData, r, remarkList, startDate;
	      ...
	      remarkList = ['吸烟和饮酒会影响卵子和精子的质量，增加流产和胎儿畸形的风险哦。这个阶段，除了补叶酸，还要补各种微量元素，这样对胚胎发育很有好处呢。受精的关键时期要远离放射线、有毒化学物质，它们会影响受精卵的质量。现在得少喝点咖啡了，每天咖啡因最好不超过200毫克，也就是一杯的量哦。现在，你可能会觉得比平时容易累和乏，记得多给自己一些休息的时间哦。受精卵还在悄悄变化着，不过你现在可能还感觉不到自己已经怀孕啦~', '现在，你的子宫略微增大一点了，由扁形变为圆形，大小像鸭蛋一样了。调皮的胚胎开始给你传递信号啦，你可能会感到小腹胀痛，乳头偶尔有刺痛感！', '胚胎已经在你子宫里安家了，记得每天要补足够的叶酸，预防胎儿神经管畸形哦。', '现在你可能会感到自己的阴道分泌物增多注意保持外阴的清洁哦。', '胚胎期是胎儿器官分化的关键阶段，这时要尽量远离X光和其他有害放射物哦。', '钙是胚胎发育的关键营养素之一，记得多吃含钙食物，多晒太阳促进钙吸收哦。', '你可能要开始孕吐了，试一试少吃多餐吧会有意想不到的好效果哟。', '在雌激素和孕激素的作用下，你开始出现胸部胀痛、乳房增大等情况。', '你的基础体温持续升高，开始感到疲倦、犯困、尿频了，真是辛苦了。', '现在开始养成良好的生活习惯，远离烟酒早睡早起，对你和宝宝都有好处哦~', '现在，胚胎在你的子宫里迅速成长，不过从外表看，很难知道你怀孕了。', '每个人的孕吐程度与身体状况、精神状态等因素有关，若孕吐严重要及时就医。', '安静舒适的环境、平和的心态，会有助于你提高睡眠质量哦。', '你可以每天用手轻轻按摩乳房，或者用热敷的方式，来缓解乳房的不适哦。', '确保每天摄入60-70g的蛋白质，对胎宝宝的健康成长可是至关重要呢。', '挑选食品时，要仔细看配料表哦，选择健康有营养的食物，对胎宝宝发育有好处。', '孕6-8周最好去医院检查一下哦，确认是否宫内孕，这样才能安心养胎哦。', '你的孕吐可能更严重了，可以试试吃苏打饼干或水果，有助于缓解不适哦。', '你最近是不是动不动就发脾气?这是激素变化引起的，不要太担心呢。', '最近你的嗜睡症状可能更加明显，不过到孕中期就会有很大缓解啦。', '你的乳房胀痛感更强烈，胸部继续变大。记得要坚持按摩，穿宽松的文胸哦。', '记得每隔1~2个小时适当地站起来活动一下，不要长时间久坐哦。', '如果不小心生病了，要在医生的指导下治疗，不要自己随便吃药哦。', '目前胚胎着床尚不稳定，出现流产的概率还是很高的，最好避免激烈的运动哦。', '多吃富含维生素、微量元素锌以及蛋白质的食物，对胚胎的健康发育有益哦。', '你的阴道黏膜开始充血，颜色变深了;子宫也开始增大，可能会有轻微下腹痛。', '子宫的日益增大压迫着你的膀胱，尿频的现象开始增多。适当控制盐分摄入哦。', '最近你可能会感觉比之前更加疲惫了，晚上睡前用温水淋浴，会舒服一些哦~', '你可能会感到心悸气闷，没有食欲，可以挑些健康可口的零食相伴哦。', '你偶尔会感到肚子有轻微抽痛，别担心，这其实是胚胎在快速成长呢。', '目前你还无需进行胎教哦，因为现在还是胚胎期，宝宝还没有听觉和触觉呢。', '早孕反应会让你十分烦躁，那就把不开心都发泄出来吧，别憋坏自己了。', '你的乳晕上开始出现乳晕腺了，也叫蒙氏结节，能分泌油脂保护乳头乳晕哦。', '孕期你的脸上可能会长斑，乳晕颜色会变深，这些变化通常会持续到分娩后。', '孕期阴道的分泌物会增多，记得每天用温水清洗外阴，内裤也要常换哦。', '随着血流量的增加，你的腿部、胸部和腹部的静脉更加清晰了呢。', '胸部胀大可能会让你有些不适，同时乳晕和乳头也开始变黑，这都是正常的。', '如果孕吐严重，可以尝试吃些清淡的粥和易消化的食物，比如馒头、面包片。', '你或许会变得喜欢吃某一种口味的食物，但烧烤、油炸等食品要少吃哦。', '子宫慢慢变大，使得肠道蠕动速度减慢，你可能会出现便秘的情况。', '你可能会发现腰部、臀部开始变粗变宽，这是身体在为将来的分娩做准备呢。', '现在你可能还会嗜睡、容易疲劳，注意要顺其自然，累了就休息，不要硬撑。', '多吃些富含膳食纤维的食物，如新鲜的水果、蔬菜，有助于预防和缓解便秘哦。', '外出时，建议穿舒适的鞋子，暂时把高跟鞋放一边，对你和宝宝的健康有益哦。', '你现在可能常感到头晕，试试躺下，保持头低脚高的姿势，会好点哦。', '要是你常觉得焦躁不安，要多和家人、朋友聊聊天，及时调整好自己的心态哦。', '你的腹部渐渐开始隆起，可以穿些宽松衣物过渡。另外，要开始准备孕妇装啦!', '孕期牙龈可能会容易出血，这时候要注意补充维生素C，加强口腔卫生哦。', '尿液在膀胱停留的时间越长细菌就越容易繁殖。所以最好不要憋尿哦!', '色素沉着并开始不断加深，你身上的胎记或斑点颜色加深，这都是正常的。', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''];
...
/***/ function(module, exports, require) {
	...
	require(19)(".file-style{padding-left:4px}.dir-style{text-align:left}");
...
/***/ function(module, exports, require) {
	...
	require(19)(".change-color{margin:0 auto}.ring-light{stroke:red;stroke-dasharray:400;stroke-dashoffset:400;animation:glow 2s ease-in-out infinite}");
...
/***/ function(module, exports, require) {
	...
	require(19)(".circle{margin:0 auto;text-align:center}.button-group .button{width:100px;cursor:pointer;height:100px;border-radius:10%;background-color:#fc0;color:#fff;text-align:center;line-height:100px;border:1px dotted #666}.picker_name{color:#fff}.white_button{color:#000}#camera-container{margin-top:20px;display:flex;justify-content:center}#camera-video{width:320px;height:240px;border:1px solid #ccc;border-radius:10px}");
	var __vue_template__ = "<div id=\"light-box\">\n    <div class=\"circle\">\n      <svg width=\"200\" height=\"200\" viewBox=\"0 0 200 200\" xmlns=\"http://www.w3.org/2000/svg\">\n      <!-- 背景圆 -->\n      <circle cx=\"100\" cy=\"100\" r=\"80\" fill=\"none\" stroke=\"#e0e0e0\" stroke-width=\"20\"></circle>\n      <!-- 主体圆环 -->\n      <circle cx=\"100\" cy=\"100\" r=\"80\" fill=\"none\" stroke=\"#ffcc00\" stroke-width=\"20\"></circle>\n    </svg>\n    </div>\n    <!-- 尝试将这个组件用Popup打开 -->\n    <p>点击改变背景颜色</p>\n    <div class=\"button-group am-flex\" v-repeat=\"getColorGroups()\">\n      <div class=\"button am-flex-item\" v-repeat=\"row\" v-styles=\"color\" v-touch=\"changeColorAction\">\n        <p class=\"picker_name\" v-css=\"{ 'white_button': index == 3 }\">\n          {{ title }} {{$index}}\n        </p>\n      </div>\n    </div>\n  </div>";
	module.exports = {
	  name: 'ColorPicker',
	  ready: function() {
	    var isChrome, ua;
	    ua = navigator.userAgent;
	    return isChrome = /(?:Chrome|CriOS)/.test(ua);
	  },
	  methods: {
	    initCamera: function() {
	      var constraints;
	    ...
	    changeColorAction: function() {
	      ...
	      div.style.cssText = this.vm.color;
	      div2 = document.getElementById('ys-list');
	      return div2.style.cssText = this.vm.color;
	    },
	      ...
	      return [
	        {
	          row: [
	            {
	              title: "美美粉",
	              color: "background-color: rgba(246, 207, 222, 1.0)"
	            }, {
	              title: "高雅紫",
	              color: "background-color: rgba(129, 50, 229, 1.0)"
	            }, {
	              title: "高冷青",
	              color: "background-color: rgba(184, 240, 249, 1.0)"
	            }
	          ]
	        }, {
	          row: [
	            {
	              index: 3,
	              title: "百搭白",
	              color: "background-color: rgba(255, 255, 255, 1.0)"
	            }, {
	              title: "暖色光",
	              color: "background-color: rgba(252, 239, 112, 1.0)"
	            }, {
	              title: "清澈蓝",
	              color: "background-color: rgba(92, 132, 235, 1.0)"
	            }
	          ]
	        }, {
	          row: [
	            {
	              title: "夕阳光",
	              color: "background-color: rgba(220, 106, 62, 1.0)"
	            }, {
	              title: "小红书",
	              color: "background-color: rgba(234, 68, 91, 1.0)"
	            }, {
	              title: "AI",
	              color: "background-color: rgba(88, 105, 237, 1.0)"
	            }
	          ]
	        }
	      ];
...
/***/ function(module, exports, require) {
	...
	require(19)(".picker-dialog{position:fixed;left:0;bottom:0;width:100%;background:#eee;z-index:101;-webkit-transition-property:-webkit-transform;transition-property:transform;-webkit-transition-duration:.3s;transition-duration:.3s}.picker-mask{display:block;position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,.5);opacity:0;-webkit-tap-highlight-color:transparent;-webkit-transition:all .2s;transition:all .2s;z-index:-1}.picker-mask.show{opacity:1;z-index:100}.popup-enter{background-color:red;-webkit-transform:translate3d(0,100%,0);transform:translate3d(0,100%,0)}.popup-leave{-webkit-transform:translate3d(0,100%,0);transform:translate3d(0,100%,0)}");
	var __vue_template__ = "<div transition=\"popup\" style=\"auto\" v-show=\"showPopup\">\n    <div style=\"text-align: center\">\n        <p>欢迎使用MY.补光灯</p>\n    </div>\n    <div v-component=\"colorPicker\"></div>\n  </div>";
	module.exports = {
	  props: {
	    show: {
	      type: Boolean,
	  ...
	  ready: function () {
	    var _this = this
	    window.popupInst = new window.Popup({
	      input: "#JS_dialog",
	      container: _this.$el,
	      innerHTML: "",
	      onOpen: function(dialog){
	        console.log(window.app, '当前this')
	      },
	      onClose: function(dialog){
	        console.log(window, '当前this')
	        window.app.showPopup = false
	      }
	    })
	  },
	  watch: {
	    show: function (val){
	      if(val){
	        window.popupInst.show()
	      }else{
	        window.popupInst.hide()
	      }
	    }
	  }
	}
